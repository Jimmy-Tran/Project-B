static class Menu
{
    ...
    static public void TestStart()
    {
        ...
        Console.WriteLine("Prototype Start Menu!");
        Console.ResetColor();
...
while (!isSelected)
{
	...
	Console.WriteLine($"{(option == 2 ? decorator : "   ")}Zie menu kaart\u001b[0m");
	Console.WriteLine($"{(option == 3 ? decorator : "   ")}Reservering Maken\u001b[0m");
    Console.WriteLine($"{(option == 4 ? decorator : "   ")}Locatie\u001b[0m");
    Console.WriteLine($"{(option == 5 ? decorator : "   ")}Afsluiten\u001b[0m");
